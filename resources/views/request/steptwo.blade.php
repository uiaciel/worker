...
@section('content')
    @if (Auth::id() == 2)
        ...
        <div class="container-fluid bg-secondary mt-n22 px-6">
            <div class="row ">
                    ...
                    <div class="card">
                            ...
                            <div>
                                <div class="d-flex justify-content-between align-items-center">
                                  ...
                                  <div>
                                    ...
                                    <a href="/print/{{$order->inv}}" class="btn btn-primary" target="_blank">Print</a>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" value="{{$order->shipnumber}}" max="100" min="1" class="form-control" name="shipnumber"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="fishingarea" value="{{$order->fishingarea}}" class="form-control" id="inputPassword">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="member" value="{{$order->member}}" class="form-control" id="inputPassword">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                        <input type="text" value="{{$order->periode}}" name="periode" class="form-control" id="inputPassword">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                          ...
                                          <input type="text" name="start" id="datestart" value="{{$order->start}}" class="form-control">
                                  ...
                                  <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group">
                                          <span class="input-group-text" id="inputGroup-sizing-default">Date</span>
                                          <input type="text" name="end" id="dateend" class="form-control" value="{{$order->end}}">
                                            <span class="input-group-text" id="inputGroup-sizing-default">Port</span>
                                ...
                                <table class="table table-bordered mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase small font-weight-bold">Remark</th>
                                    ...
                                    <tbody>
                                        @foreach ($orderjob as $index => $job)
                                            <tr>
                                                ...
                                                <td>{{ $job->remark }}</td>
                                                <td>
                                                    <form method="POST" action="{{ route('orderjob.destroy', $job->id) }}">
                                                        {{ csrf_field() }}
                                                        {{ method_field('DELETE') }}
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="ms-3 ">
                                    ...
                                    <p class="text-muted mb-2">Please do approval to the selected crew(s) below!
                                    </p>
                        ...
                        <div class="card-header bg-white  py-4">
                            <div>
                                <div class="d-flex justify-content-between align-items-center">
                                  <div class="mb-2 mb-lg-0">
                                    <h4 class="mb-0">To: PT. ANGKASA AKBAR TARUNA (AAT)
                                        <br>From: JAPAN TUNA FISHERIES CORPORATION (JTFC)</h4>
                                  </div>
                                  <div>
                                    <a href="/orderprint/{{$order->inv}}" target="_blank" class="btn btn-primary">Print Crew Profile</a>
                                  </div>
                                </div>
                              </div>  
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="ms-3 ">
                                    <h5 class="mb-1">Admin AAT</h5>
                                    <p class="text-muted mb-2">Thank you! Please kindly find our offer below!
                                    </p>
                                    <p class="fs-5 mb-0">2m ago</p>
                                </div>
                            </div>
                ...
                <div class="col-md-12 col-12">
                    ...
                    @csrf
                                <div class="mb-3 row">
                                        ...
                                        <label for="shipowner" class="col-sm-3 col-form-label">Please Confirm {{$ticket->id}}</label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="ms-3 ">
                                    <h5 class="mb-1">Admin AAT</h5>
                                    <p class="text-muted mb-2">Please kindly arrange & upload Air Ticket(s) & Guarantee Letter of All Crews below!
                                    </p>
                                    <p class="fs-5 mb-0">2m ago</p>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex ">
                                ...
                                <div class="ms-3 ">
                                    <h5 class="mb-1">Admin AAT</h5>
                                    <p class="text-muted mb-2">"Thank you! Now you can check status of All Crew(s) Immigration Pass below!
                                    </p>
                                    <p class="fs-5 mb-0">2m ago</p>
                                </div>
                            </div>
            ...
            <div class="col-md-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <p style="margin-left: 25px;" class="mb-3">Estimated Date of Embarkation: {{$order->start}}</p>
                                <p style="margin-left: 25px;" class="mb-3">Estimated Date of Disembarkation: {{$order->end}}</p>
                  ...
                  <div class="card-body">
                      ...
                      <div class="d-flex ">
                          ...
                          <div class="ms-3 ">
                              ...
                              <p class="text-muted mb-2">Hello! We need crew(s), please kindly arrange!
                              </p>
                              <p class="fs-5 mb-0">2m ago</p>
                          </div>
                      </div>
                    ...
                    <div class="card-header bg-white  py-4">
                      <div>
                          <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                              <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#datacrewnya">Add Crews</a>
                            </div>
                          </div>
                        </div>
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <div class="d-flex ">
                          ...
                          <div class="ms-3 ">
                              <h5 class="mb-1">Admin AAT</h5>
                              <p class="text-muted mb-2">Thanks for your response, we have done crew(s) selection. Please kindly arrange!
                              </p>
                              <p class="fs-5 mb-0">2m ago</p>
                          </div>
                      </div>
                ...
                <div class="card-header bg-white  py-4">
                    <div>
                        <div class="d-flex justify-content-between align-items-center">
                          ...
                          <div>
                            <a href="/orderprint/{{$order->inv}}" target="_blank" class="btn btn-primary">Print All Crew</a>
                            <a href="/orderprint/{{$order->inv}}" target="_blank" class="btn btn-primary">Print Approved Crews</a>
                          </div>
                        </div>
                      </div>
                ...
                <div class="card-header bg-white  py-4">
                  <div>
                      <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                          <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#penawarantiket">Buat Penawaran</a>
                        </div>
                      </div>
                    </div>
 ...
 <div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
       <button class="accordion-button btn-primary" type="button" data-bs-toggle="collapse"
          data-bs-target="#penawaran{{$tikets->id}}" aria-expanded="true" aria-controls="collapseOne">
       Penawaran #{{$tikets->id}} - <strong>@if(is_null($tikets->status)) menunggu respon @else {{$tikets->status}} @endif</strong>
       </button>
    </h2>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <!-- Modal -->
<div class="modal fade" id="penawarantiket" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="{{ route('ticket.store') }}" method="POST" >
                    @csrf
                        ...
                        <!--<h5>DOCUMENT FOR AGENT & F/MASTER WILL KEEP BY MR. MOCHIN TIME LIMID SOON <br>BOOKING CODE: 5L37LH</h5> -->
                    </textarea>
