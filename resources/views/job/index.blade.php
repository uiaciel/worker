        ...
        <div>
          <div class="d-flex justify-content-between align-items-center">
            <div class="mb-2 mb-lg-0">
              <h3 class="mb-0  text-white">Job List</h3>
            </div>
            <div>
                            ...
                            <tr>
                              ...
                              <th scope="row">
                                <div class="input-group mb-3">
                                  <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#com{{$job->id}}">Edit</button>
                              ...
                              <!-- Modal -->
  <div class="modal fade" id="com{{$job->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <div class="form-group mb-3">
              ...
              <div class="form-group mb-3">
                <label for="exampleInputEmail1">Job Code</label>
                <input type="text" name="code" value="{{$job->code}}" class="form-control">
              </div>
