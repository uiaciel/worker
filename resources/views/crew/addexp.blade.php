            ...
            <form action="{{ route('exp.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select class="form-select select2" data-placeholder="--SELECT--" name="vesselsname">
                            <option></option>
                            @foreach ($shipnames as $shipname)
                                <option value="{{ $shipname->id }}">{{ $shipname->name }}</option>
                            @endforeach
                        </select>
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select" name="maru">
                                    <option value="Maru">Maru</option>
                                    <option value="">Non Maru</option>
                                </select>

                                <input type="number" name="shipnumber" max="10000" min="0" class="form-control"
                                    name="number">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="crew_id" class="form-label">凍結・生 | Raw Freezing</label>
                        ...
                        <div class="mb-3">
                            <label for="crew_id" class="form-label">主漁場 | Fishing Ground</label>
                        ...
                        <div class="mb-3">
                            <label for="crew_id" class="form-label">漁労長 | Fishing Master</label>
                        ...
                        <div class="mb-3">
                            <label for="crew_id" class="form-label">下船理由 | Disembark. Reason</label>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="crew_id" class="form-label">Name</label>
                        <input type="text" class="form-control" id="crew_id" value="{{ $crew->name }}" readonly>
                    </div>
                </div>
            </div>
        </div>
