      ...
      <div>
        <div class="d-flex justify-content-between align-items-center">
          <div class="mb-2 mb-lg-0">
            <h3 class="mb-0  text-white">Port Names</h3>
          </div>
          <div>
                            ...
                            <tr>
                              ...
                              <th scope="row">
                                <div class="input-group mb-3">
                                  <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#com{{$port->id}}">Edit</button>
                              ...
                              <!-- Modal -->
  <div class="modal fade" id="com{{$port->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
