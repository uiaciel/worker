                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                      ...
                                                      action="{{ route('orderjob.destroy', $job->id) }}" method="POST">
                                                      ...
                                                      data-bs-target="#datacrewnya" id="creww">Select Crew(s)</button>
                    ...
                    <div class="card-header bg-white  py-4">
                        <div>
                            <div class="d-flex">
                                <div class="mb-2 mb-lg-0 flex-fill">
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                                        <h4 class="mb-0 text-center">Thank you for trusting us & looking forward to The
